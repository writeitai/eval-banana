...
def run_checks(
    *,
    ...
    """Top-level orchestration: discover checks, run harness, execute checks, score.
    ...
    5. Run the harness worker step (if configured).
    6. Execute each selected check via its type-specific runner.
    7. Score results, emit reports, and return the :class:`EvalReport`.
    """
